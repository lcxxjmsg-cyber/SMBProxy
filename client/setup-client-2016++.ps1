<#
.SYNOPSIS
    SMBProxy - Windows Server 2016/2019/2022/2025 (v4.5 - 双模式)
.DESCRIPTION
...
# --- 系统检测: Windows Server 2016+ (版本 10.x, 服务器) ---
$os = Get-CimInstance Win32_OperatingSystem
if (-not ($os.Version -like "10.*") -or $os.ProductType -eq 1) {
    Write-Host "[错误] 本脚本仅适用于 Windows Server 2016/2019/2022/2025, 当前: $($os.Caption)" -ForegroundColor Red; pause; exit 1
}
Write-Host "[系统] $($os.Caption) — Server 2016+ 模式" -ForegroundColor Cyan
...
$TaskName = "SMBProxy_Engine"; $LocalPort = 445; $FwPrefix = "SMBProxy-S2016"
...
function Show-Menu {
    ...
    Write-Host "     SMBProxy - Server 2016+ (v4.5)                 " -ForegroundColor Cyan
    Write-Host "====================================================" -ForegroundColor Cyan
    $mode = Get-Mode
